...
macro Encrypt_Run MODE
	local @@ForLoop, @@whileLoop, @@Reg, @@Next, @@SKIP_OPENING, @@EXIT, @@SKIP_OPENING_DECRYPTION, @@EXIT_DECRYPTION, @@PRINT_DECRYPTION, @@PRINT_DOTS
	...
	ELSE
		...
		cmp [iteration_time], 0
		jne @@SKIP_OPENING_DECRYPTION

		File_Open '..\Output.txt', 2, outputFileHandle

		@@SKIP_OPENING_DECRYPTION:
